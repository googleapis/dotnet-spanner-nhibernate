...
{
    public class SingerWithVersion
    {
        ...
        public virtual IList<AlbumWithVersion> Albums { get; set; }
    }

    public class SingerWithVersionMapping : ClassMapping<SingerWithVersion>
    {
        public SingerWithVersionMapping()
        {
            Persister<SpannerSingleTableEntityPersister>();
            DynamicUpdate(true);
            Table("SingersWithVersion");
            ...
            Property(x => x.FullName, m =>
            {
                ...
                m.Index("Idx_SingersWithVersion_FullName");
            });

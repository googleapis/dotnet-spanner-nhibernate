...
namespace Google.Cloud.Spanner.NHibernate.Tests
{
    ...
    public class NHibernateMockServerFixture : SpannerMockServerFixture
    {
        public NHibernateMockServerFixture()
        {
            ...
            nhConfig.GetClassMapping(typeof(Singer)).EntityPersisterClass = typeof(SpannerMutationsEntityPersister);
            ...
            nhConfig.GetClassMapping(typeof(TableWithAllColumnTypes)).EntityPersisterClass = typeof(SpannerMutationsEntityPersister);

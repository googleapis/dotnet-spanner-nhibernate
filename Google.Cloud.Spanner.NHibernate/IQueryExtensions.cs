...
namespace Google.Cloud.Spanner.NHibernate
{
    ...
    public static class IQueryExtensions
    {
        ...
        public static IQuery SetJoinHint(this IQuery query, string table, string hint)
        {
            GaxPreconditions.CheckNotNull(query, nameof(query));
        ...
        public static IQuery SetJoinHints(this IQuery query, Dictionary<string, string> hints)
        {
            GaxPreconditions.CheckNotNull(query, nameof(query));
            GaxPreconditions.CheckNotNull(hints, nameof(hints));
            var builder = new StringBuilder($"{SpannerQueryHintInterceptor.SpannerQueryHintsPrefix}");
        ...
        public static IQuery SetStatementAndJoinHints(this IQuery query, string statementHint, Dictionary<string, string> joinHints)
        {
            GaxPreconditions.CheckNotNull(query, nameof(query));
            GaxPreconditions.CheckNotNullOrEmpty(statementHint, nameof(statementHint));
        ...
        public static IQuery SetTableAndJoinHints(this IQuery query, Dictionary<string, string> tableHints, Dictionary<string, string> joinHints)
        {
            GaxPreconditions.CheckNotNull(query, nameof(query));
            GaxPreconditions.CheckNotNull(tableHints, nameof(tableHints));
            GaxPreconditions.CheckNotNull(joinHints, nameof(joinHints));
        ...
        public static IQuery SetStatementAndTableAndJoinHints(this IQuery query, string statementHint, Dictionary<string, string> tableHints, Dictionary<string, string> joinHints)
        {
            GaxPreconditions.CheckNotNull(query, nameof(query));
            GaxPreconditions.CheckNotNullOrEmpty(statementHint, nameof(statementHint));
            GaxPreconditions.CheckNotNull(tableHints, nameof(tableHints));
